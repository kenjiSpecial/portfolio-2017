...
export default class Particles extends THREE.Points  {
    constructor(params) {
        ...
        let totalLength = params.number || 1200; //params.geometry.vertices.length;
        ...
        let mat = new THREE.ShaderMaterial({
            ...
            depthTest : false,
            vertexShader : glslify('../../shaders/keyObjectParticle2.vert'),
            fragmentShader : glslify('../../shaders/keyObjectParticle2.frag')
        });
